...
public class ServiceRdv implements IService<RendezVous> {
        ...
        request.addResponseListener((evt) -> {
            try {
                ...
                for (Map<String, Object> obj : list) {
                    String idPatient = obj.get("id_medecin").toString();
                    if (idPatient.equals("Sleh")) { // Filtrer par ID patient
                        String date = obj.get("date").toString();
                        String medecin = obj.get("id_patient").toString();
    ...
    public boolean ajouter(RendezVous r,Date d) {
        ...
        SimpleDateFormat outputDateFormat = new SimpleDateFormat(outputFormat);
            ...
            request.addArgument("id_patient", r.getPatient());
            request.addArgument("id_medecin", "Sleh");
