...
public class Commande {
    ...
    public Commande(int ID_pharmacie, String adresse, String nom_pharmacie, String date_commande, String etat) {
    ...
    public Commande(int ID_commande, int ID_pharmacie, String adresse, String nom_pharmacie, String date_commande, String etat) {
    ...
    public Commande(int ID_commande, int ID_pharmacie, String adresse, String date_commande, String etat) {
        this.ID_commande = ID_commande;
        this.ID_pharmacie = ID_pharmacie;
        this.adresse = adresse;
        this.date_commande = date_commande;
    ...
    public Commande(int ID_pharmacie,  String adresse, String date_commande, String etat) {
        this.ID_pharmacie = ID_pharmacie;
        this.adresse = adresse;
        this.date_commande = date_commande;
        this.etat = etat;
    ...
    public int hashCode() {
        int hash = 3;
        hash = 73 * hash + this.ID_commande;
        hash = 73 * hash + this.ID_pharmacie;
        hash = 73 * hash + Objects.hashCode(this.adresse);
        hash = 73 * hash + Objects.hashCode(this.nom_pharmacie);
        hash = 73 * hash + Objects.hashCode(this.date_commande);
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equals(this.date_commande, other.date_commande);
    }
